...
const mockProfiles = {
  1: { name: 'Elena Mora', specialty: 'Retrato', avatar: 'https://i.pravatar.cc/150?img=5', banner: 'https://images.unsplash.com/photo-1518837695005-2083093ee35b?w=1200&h=400&fit=crop', rating: 4.9, price: 350000, delivery: '3 días', bio: 'Fotógrafa editorial con base en Bogotá. Trabajo con luz natural y narrativa íntima para retratos que perduran.', equipment: 'Canon EOS R5, 85mm f/1.4, Profoto B10', photos: ['https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=600&h=400&fit=crop','https://images.unsplash.com/photo-1452587925148-ce544e77e70d?w=600&h=400&fit=crop','https://images.unsplash.com/photo-1483985988355-763728e1935b?w=600&h=400&fit=crop','https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=600&h=400&fit=crop'] },
  2: { name: 'Marc Dubois', specialty: 'Moda', avatar: 'https://i.pravatar.cc/150?img=15', banner: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?w=1200&h=400&fit=crop', rating: 4.8, price: 500000, delivery: '5 días', bio: 'Moda y editorial en París. Colaboro con diseñadores emergentes y revistas independientes.', equipment: 'Sony A7R IV, 50mm f/1.2 GM', photos: ['https://images.unsplash.com/photo-1483985988355-763728e1935b?w=600&h=400&fit=crop','https://images.unsplash.com/photo-1518837695005-2083093ee35b?w=600&h=400&fit=crop','https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&h=400&fit=crop'] },
}

const defaults = { name: 'Artista LuxArts', specialty: 'Editorial', avatar: 'https://i.pravatar.cc/150?img=12', banner: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=1200&h=400&fit=crop', rating: 4.8, price: 300000, delivery: '4 días', bio: 'Creador visual verificado en LuxArts. Portafolio curado con acabado cinematográfico.', equipment: 'Canon EOS R6, 35mm f/1.4', photos: ['https://images.unsplash.com/photo-1452587925148-ce544e77e70d?w=600&h=400&fit=crop','https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=600&h=400&fit=crop','https://images.unsplash.com/photo-1518837695005-2083093ee35b?w=600&h=400&fit=crop'] }
...
const ArtistProfile = () => {
  ...
  // SCRUM-32 Part 2: protección acciones públicas
  const handleBooking = () => {
    if (!isAuthenticated) {
      navigate('/login')
      return
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6">
          <div className="mx-auto max-w-7xl flex items-end gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-300">{p.specialty} • <span className="text-red-400">★ {p.rating.toFixed(1)}</span> • ${p.price.toLocaleString('es-CO')} COP/sesión</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 rounded-2xl border border-red-600/20 bg-zinc-950 p-6 shadow-xl shadow-black/30">
              ...
              <p className="mt-2 text-2xl font-bold text-white">${p.price.toLocaleString('es-CO')} <span className="text-sm font-normal text-zinc-500">COP / sesión</span></p>
              ...
              <Button variant="primary" className="w-full mt-6 py-3.5" onClick={handleBooking}>Solicitar Reserva</Button>
